...
/**
 * Moves an actor exactly from grid center to grid center. Large or tiny time steps
 * cannot skip an intersection, which keeps controls identical at 60, 120 and 175 Hz.
 */
