export const TEXT = {
  standard: {
    startupBootKicker: 'SONDERAKTE F-60 · SYSTEMSTART',
    startupBootTitle: 'Passau-Einsatzsystem fährt hoch …',
    startupBootWait: 'KARTE WIRD GLEICH FREIGEGEBEN',
    startupBootLineOne: 'Personalakte Franz · 60 bestätigt',
    startupBootLineTwo: 'Gassi-Leitsystem wird kalibriert',
    startupBootLineThree: 'Neun Passauer Einsatzorte werden geladen',
    startupBootLineFour: 'Lola-Verbindung steht · Karte bereit',
    ...
    audioOutputLabel: 'AUSGABEGERÄT', audioOutputSpeaker: 'LAUTSPRECHER', audioOutputHeadphones: 'KOPFHÖRER',
    audioOutputCopy: 'Lautsprecher hebt Stimme und Atmosphäre deutlich an. Kopfhörer bewahrt mehr Dynamik.',
  ...
  dialect: {
    startupBootKicker: 'SONDERAKT F-60 · SYSTEMSTART',
    startupBootTitle: 'S’Passauer Einsatzsystem fahrt hoch …',
    startupBootWait: 'D’KARTN WERD GLEI FREIGEBN',
    startupBootLineOne: 'Personalakt Franz · 60 bestätigt',
    startupBootLineTwo: 'Gassi-Leitsystem werd eingschossn',
    startupBootLineThree: 'Neun Passauer Einsatzplatzerl werdn gladn',
    startupBootLineFour: 'Lola-Verbindung steht · Kartn is fertig',
    ...
    audioOutputLabel: 'AUSGABGERÄT', audioOutputSpeaker: 'LAUTSPRECHER', audioOutputHeadphones: 'KOPFHÖRER',
    audioOutputCopy: 'Lautsprecher hebt Stimm und Stimmung deutlich o. Kopfhörer lasst mehr Dynamik drin.',
